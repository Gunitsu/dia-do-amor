...
div.innerHTML = "<div><small>Feliz dia dos Namorados</small></div><div>Gustavo e Grasieli</div>";
app.appendChild(div);

//create silver ring icon
div = document.createElement("div");
div.classList.add("draw__ring");
app.appendChild(div);

img = document.createElement("img");
img.setAttribute("src", "src/img/silver_ring.png");
div.appendChild(img);
